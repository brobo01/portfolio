  ...
  return (
    <main>
      ...
      <article className={styles.blogWrap}>
        ...
        <h1>No Such Thing As A Full Stack Developer</h1>
        <div className={styles.meta}>
          10 min read · April 2026 · A take on team structure, specialisation,
          and the myth of the unicorn hire
        </div>

        <p className={styles.lead}>
          We've been collectively pretending that a single developer can be
          genuinely excellent at both frontend and backend work. I think it's
          time to have an honest conversation about why that's mostly not true —
          and what it means for how we build teams.
        </p>
        ...
        <p>
          ...
          <em>idea</em> of a developer who is equally skilled, equally
          passionate, and equally current across both frontend and backend is
          largely a convenient fiction that companies tell themselves when they
          want to hire one person instead of two.
        </p>
        ...
        <p>
          Ask ten full stack developers to describe their work and you'll get
          ten variations of the same honest confession:{" "}
        ...
        <p>
          ...
          . Keeping up with one is a full-time job. Keeping up with both,
          deeply, at the same time, is not realistically possible for most
          people.
        </p>
        ...
        <p>
          ...
          metrics, Core Web Vitals. It means knowing when to reach for a CSS
          Grid and when to reach for a library. It means having opinions about
          state management that are based on real tradeoffs rather than blog
          post trends.
        </p>

        <p>
          Now think about what genuine backend expertise means. Deep
          understanding of database query planning and indexing strategies.
          Distributed systems concepts — consistency models, CAP theorem in
          practice, not just in theory. API design, auth flows, rate limiting,
          caching strategies. Message queues, event-driven architecture,
          observability, performance profiling. Security: not just "use HTTPS"
          but threat modelling, injection prevention, secrets management.
        </p>
        ...
        <p>
          ...
          than bad code: <em>capability debt</em>. The frontend is functional
          but not great. The backend works but isn't as robust as it should be.
          Nobody is deeply accountable for either because one person is doing
          both. When the product scales, these gaps become expensive problems.
        </p>
        ...
        <p>
          ...
          someone who writes React faster. You're getting someone who has
          thought deeply about user experience as a discipline. Who notices when
          a loading state is wrong before a user complains. Who understands that
          performance is a feature, and knows how to measure and improve it. Who
          has strong opinions about component APIs because they've designed
          hundreds of them.
        </p>

        <p>
          When you hire a specialist backend developer, you're getting someone
          who thinks about failure modes as a habit. Who designs APIs for the
          consumers who'll use them, not just the business logic that powers
          them. Who knows that "it works" and "it works reliably at scale under
          adverse conditions" are completely different statements. Who loses
          sleep over database migrations in ways that are ultimately very good
          for your data.
        </p>
        ...
        <p>
          Here's the thing I've noticed consistently across every team I've
          worked in or spoken to: developers always have a preference. Always.
          They might suppress it, especially if they've been hired as "full
          stack" and feel obligated to present themselves as equally comfortable
          everywhere. But ask them privately — or watch where they gravitate
          when nobody is assigning tickets — and the preference emerges.
        </p>
        ...
        <p>
          ...
          distributed systems papers, database internals, and API design
          patterns.
        </p>
        ...
        <p>
          ...
          the work on both sides, but they'll shine on one and coast on the
          other. That coasting — done by someone who is otherwise talented and
          committed — is often not caught until it's become a real problem.
        </p>
        ...
        <div className={styles.callout}>
          <p>
            ...
            thirty seconds of that answer than in an hour of technical
            questions.
          </p>
        </div>
        ...
        <div className={styles.scenarioGrid}>
          ...
          <div className={styles.scenario}>
            ...
            <p>
              You're building an API product, a data platform, or
              infrastructure. Your core value is in what happens server-side.
              Your frontend is a dashboard or admin interface, not a consumer
              experience.
            </p>
          </div>
        </div>
        ...
        <p>
          ...
          frontend-complex. Most B2B data tools are backend-complex. Most
          products that have scaled past a few thousand users discover they
          underinvested in whichever side they deprioritised early on.
        </p>
        ...
        <p>
          I've spent most of this post arguing against the fiction, but I want
          to be fair. There are developers who genuinely thrive in a full stack
          role — not because they're equally expert at everything, but because
          they're excellent at the thing that full stack actually requires:{" "}
          <em>
            context switching, end-to-end ownership, and knowing enough about
            both sides to make good decisions at the seams.
          </em>
        </p>
        ...
        <p>
          ...
          database migration through to the UI and feel accountable for all of
          it brings a kind of coherence that handoffs between specialists
          sometimes lose.
        </p>

        <p>
          The problem isn't full stack developers. The problem is job
          descriptions that use "full stack" to mean "we want a frontend
          developer, a backend developer, and a DevOps engineer, but we're only
          going to hire one person." That's not a full stack role — that's an
          unrealistic expectation packaged in a palatable label.
        </p>
        ...
        <div className={styles.verdictBox}>
          ...
          <p>
            ...
            because the title is fraudulent, but because the expectation of
            equal depth across both disciplines sets developers up to be
            adequate at two things rather than excellent at one. Every developer
            you've ever worked with who called themselves full stack has a side
            they love more. That preference is information worth acting on.
          </p>
          <p>
            For most products past the MVP stage, two specialists — one
            frontend, one backend — will outperform one full stack hire. They'll
            produce better work, catch each other's blind spots, and each have
            someone they can learn from on their side of the stack. The
            collaboration overhead is real, but it's worth it.
          </p>
          <p>
            If budget forces the choice, hire based on where your product's real
            complexity lives — and be honest about what you're trading off on
            the other side. That honesty is better than pretending one person
            can do it all equally well. Because in fifteen years of working with
