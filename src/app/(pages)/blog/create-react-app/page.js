...
export default async function Page() {
    ...
    <main>
      ...
      <article className={styles.blogWrap}>
        ...
        <p className={styles.lead}>
          ...
          of developers to React. It served its purpose brilliantly. And it's
          time to move on — not because it's broken, but because the web has
          moved well past what it was designed for.
        </p>

        <p>
          If you've started a new React project in the last couple of years,
          you've probably noticed that <code>create-react-app</code> is no
          longer the first recommendation in the React docs. That's not an
          accident. In early 2023, the React team officially acknowledged that
          CRA was in maintenance mode — no new features, no active development,
          just security patches when absolutely necessary. By late 2024, it was
          formally deprecated.
        </p>
        ...
        <p>
          ...
          problem it was solving. In 2016, setting up a React project from
          scratch meant wiring together Webpack, Babel, ESLint, Jest, and a
          handful of loaders — each with their own configuration files, their
          own breaking changes, and their own community of Stack Overflow
          questions. It was genuinely painful, especially for developers coming
          from simpler ecosystems.
        </p>
        ...
        <p>
          ...
          production build script, and zero configuration to manage. For
          teaching React, for prototyping, and for getting teams started
          quickly, it was transformative.
        </p>

        <p>
          The problem is that "zero configuration" has a hidden cost: zero
          flexibility. CRA was designed around a specific set of assumptions
          about how React apps should be built — assumptions that made a lot of
          sense in 2016 and have aged poorly.
        </p>
        ...
        <div className={styles.warnCallout}>
          <p>
            ...
            2016 that was fine. In 2026, it puts you at a structural
            disadvantage for performance, SEO, and user experience.
          </p>
        </div>
        ...
        <p>
          ...
          page. On a fast laptop with a good connection, this is imperceptible.
          On a mid-range Android phone on a 4G connection — the actual device
          and network conditions of a majority of global web users — it's a
          meaningful delay, and it compounds as your app grows.
        </p>

        <p>
          This isn't a CRA-specific problem exactly — it's a client-side
          rendering problem. But CRA gives you no easy escape hatch. The entire
          architecture pushes you toward a model where the browser does all the
          work, and restructuring that after the fact is expensive.
        </p>
        ...
        <p>
          CRA uses Webpack under the hood, which was the right choice in 2016.
          By 2022, Webpack had accumulated enough configuration complexity and
          enough architectural overhead that cold starts and rebuild times on
          large projects had become a genuine productivity tax. Tools like Vite
          (powered by esbuild and Rollup) were demonstrably 10–100x faster for
          development server startup. CRA, locked to its Webpack foundation,
          couldn't adopt these improvements without a rewrite it was never going
          to get.
        </p>
        ...
        <p>
          ...
          Gatsby, and Expo for native apps. For most web development teams
          coming from CRA, Next.js is the most natural transition — it's React
          with a structure layered on top, rather than a different paradigm
          entirely.
        </p>
        ...
        <p>
          ...
          rendering model. In Next.js, you decide per-page (or per-component,
          with the App Router) whether content should be rendered on the server,
          generated at build time, or hydrated on the client. This granularity
          is the thing that CRA fundamentally couldn't offer.
        </p>
        ...
        <div className={styles.scenarioGrid}>
          <div className={styles.scenario}>
            <div className={styles.scenarioLabel}>Static Generation (SSG)</div>
            <p>
              Pages are rendered at build time and served as static HTML.
              Fastest possible load. Perfect for content that doesn't change
              often: marketing pages, blog posts, documentation.
            </p>
          </div>
          <div className={styles.scenario}>
          ...
          <div className={styles.scenario}>
            ...
            <p>
              ...
              sweet spot for content that changes occasionally: product
              listings, news feeds, pricing pages.
            </p>
          </div>
          <div className={styles.scenario}>
            <div className={styles.scenarioLabel}>
        ...
        <p>
          A real application typically uses all four. Your homepage is
          statically generated. Your product pages use ISR. Your checkout is
          server-rendered. Your rich text editor is client-side. CRA forced you
          to use one model for everything. Next.js lets the nature of each page
        ...
        <p>
          ...
          application, migration to Next.js is mostly mechanical. Your
          components don't need to change. Your state management doesn't need to
          change. The bulk of the work is restructuring routing and adapting to
        ...
        <p>
          ...
          existing codebase and want a more gradual transition, you can omit
          this flag and start with the Pages Router, which is closer to what
          older Next.js tutorials describe.
        </p>

        <h3>Step 2: move your components</h3>

        <p>
          Copy your <code>src/components</code> directory across wholesale.
          React components are just React components — they don't care whether
          they're running in a CRA or Next.js project. The only caveat is hooks
          and browser APIs.
        </p>
        ...
        <div className={styles.callout}>
          <p>
            ...
            browser APIs like <code>window</code> or <code>localStorage</code>,
            or event handlers — add <code>'use client'</code> at the top of the
            file. This marks it as a Client Component and restores the behaviour
            you're used to from CRA.
          </p>
        </div>
        ...
        <p>
          CRA apps typically use React Router for client-side routing. In
          Next.js, routing is filesystem-based. A file at{" "}
          <code>app/about/page.tsx</code> automatically becomes the{" "}
          <code>/about</code> route. Dynamic routes use bracket syntax:{" "}
          <code>app/blog/[slug]/page.tsx</code> maps to{" "}
          <code>/blog/anything</code>.
        </p>

        <p>
          For each React Router <code>&lt;Route&gt;</code> in your app, you're
          creating a corresponding directory and <code>page.tsx</code> file.
          It's a bit of upfront work, but you end up with a codebase where the
          URL structure is immediately legible from the file tree — something
          that always pays dividends later.
        </p>
  ...
  `}
        ...
        <p>
          For client-side data that's user-specific or highly dynamic, React
          Query and SWR still work perfectly — just use them inside Client
        ...
        <p>
          ...
          exposed to the browser. Next.js uses <code>NEXT_PUBLIC_</code>. A
          quick find-and-replace in your codebase, and update your{" "}
          <code>.env</code> files accordingly. Variables without the{" "}
          <code>NEXT_PUBLIC_</code> prefix are server-only — a nice security
          property that CRA couldn't offer.
        </p>
        ...
        <p>
          If you've looked at Next.js tutorials recently, you've probably
          noticed that some use <code>pages/</code> and some use{" "}
          <code>app/</code>. This is a genuine source of confusion for
          developers coming in fresh, so it's worth addressing directly.
        </p>
        ...
        <p>
          ...
          first-class primitives. The App Router is where all of Next.js's
          active development is happening, and it's what new projects should
          use.
        </p>

        <p>
          That said, the App Router has a steeper learning curve. The mental
          model around Server vs Client Components takes some getting used to.
          If you're migrating a large existing codebase, starting with the Pages
          Router and migrating incrementally to the App Router is a perfectly
          reasonable strategy — Next.js supports both in the same project during
          a transition period.
        </p>
        ...
        <blockquote className={styles.pullquote}>
          <p>
            ...
            — running code on the server, fetching data close to where it's
            used, not shipping unnecessary JavaScript to the browser — are good
            ideas that improve real applications. They're worth learning.
          </p>
        </blockquote>
        ...
        <p>
          ...
          default and has excellent React integration for interactive
          components.
        </p>

        <p>
          But for the vast majority of projects — products with public-facing
          pages, marketing sites, e-commerce, SaaS dashboards, anything where
          you need a mix of static and dynamic content — Next.js is the right
          tool.
        </p>
        ...
        <p>
          There's a genuine emotional component to tool deprecations that
          doesn't get talked about enough. CRA wasn't just a tool — for a lot of
          us, it's bound up with the memory of learning React, of first
          projects, of tutorials that clicked something into place. The{" "}
        ...
        <p>
          ...
          careers are the ones who hold their tools loosely — who use them
          because they're the best fit for the job today, not because they were
          the best fit for the job five years ago. CRA did its job. It
          introduced React to a generation of developers and removed friction
          that was genuinely discouraging people. That's a real legacy worth
          acknowledging.
        </p>
        ...
        <div className={styles.verdictBox}>
          ...
          <p>
            If you have an existing CRA app, you don't need to drop everything
            and migrate today. But put it on your roadmap. The longer you wait,
            the more your codebase will diverge from the patterns the ecosystem
            is moving toward, and the harder the eventual migration will become.
            Start with your next greenfield feature or your next new project.
            The path is well-worn at this point — you're far from the first
